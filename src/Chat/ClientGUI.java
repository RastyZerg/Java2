...
public class ClientGUI extends JFrame implements ActionListener, Thread.UncaughtExceptionHandler, KeyListener {
    ...
    private final int ACTION_NEW_MESSAGE = 1;
    private final String ACTION_NEW_MESSAGE_MSG = "New Message";
...
//        log.setEditable(false);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (src == cbAlwaysOnTop) {
            ...
            fillLogFile(ACTION_NEW_MESSAGE);
        }else {
    ...
    public void fillLogFile(int ACTION_EVENT){
        try {
            PrintStream out = new PrintStream(new FileOutputStream("ChatLog.txt", true));
            if (ACTION_EVENT == ACTION_NEW_MESSAGE){
                out.println(tfLogin.getText() + "   " + ACTION_NEW_MESSAGE_MSG + "   " + tfMessage.getText());
                out.flush();
                out.close();
            }
